...
this.procedures["pantalla"] = pantalla;
this.procedures["inicio"] = inicio;
this.procedures["encendido"] = encendido;
this.procedures["calibrar"] = calibrar;
this.procedures["verificado"] = verificado;
this.procedures["Luz"] = Luz;
this.procedures["apagado"] = apagado;
...
function pantalla() {
    ...
    tweenCamera('ScreamCam', 'ScreamPos', 1, function() {

        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'alarma(1,1);')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'etiquetas("ScreenText", "Verificación", null, true, null,"PantallaxPoint");')(appInstance, v3d, PL, VARS, PROC);

        registerSetTimeout(1, function() {
            changeVis('pantallax', false);
        });
    }, 1);
}
...
function encendido() {
    ...
    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'alarma(6666,0.5);')(appInstance, v3d, PL, VARS, PROC);

    tweenCamera('HomeCam', 'HomePos', 1, function() {
        changeVis('pantallagrande', false);
...
function calibrar() {
    ...
    tweenCamera('HomeCam', 'HomePos', 1, function() {
        ...
        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'alarma(20,3);')(appInstance, v3d, PL, VARS, PROC);


        Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'etiquetas("GasText", "Gas", "Para poder calibrar", true, null,"GAS");')(appInstance, v3d, PL, VARS, PROC);
...
function verificado() {
    outline(['ALL_OBJECTS'], 'DISABLE');
        changeVis('GAS', false);
        changeVis('GAS2', false);
        changeVis('GAS3', false);

    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'quitarEtiquetas();')(appInstance, v3d, PL, VARS, PROC);

    tweenCamera('StickerCam', 'HomePos', 2, function() {
        outline('sticker2', 'ENABLE');
        registerSetTimeout(1, function() {
            changeVis('sticker2', true);

            Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'etiquetas("StickerText", "Sticker", null, true, null,"sticker2");')(appInstance, v3d, PL, VARS, PROC);
...
function Luz() {
    ...
    registerSetTimeout(0.5, function() {
        changeVis('Luz1', false);
        changeVis('Luz2', false);
        registerSetTimeout(0.5, function() {
            changeVis('Luz1', true);
            changeVis('Luz2', true);
            registerSetTimeout(0.5, function() {
...
function apagado() {
    ...
    'import("../../Recursos/js/imports/Detector_import.js");')))(appInstance, v3d, PL, VARS, PROC);

    inicio();
    setCameraParam('ALLOW_PANNING', 'Camera', false);
    setCameraParam('ALLOW_ZOOM', 'Camera', false);
    changeVis('sticker2', false);
        changeVis('GAS', false);
        changeVis('GAS2', false);
        changeVis('GAS3', false);
        changeVis('Luz1', false);
